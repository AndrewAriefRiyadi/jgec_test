    ...
    <div class="container">
        <header>
            ...
            <div class="header-right">
                <h2>特定技能外国人・履歴書</h2>
                <h3>Curriculum Vitae Pekerja Asing Berketerampilan Khusus</h3>
            </div>
        </header>
            ...
            <table>
                <tbody>
                    ...
                    <tr>
                        ...
                        <td colspan="4">身長 (TB): {{$student->tinggi_badan}} cm / 体重 (BB): {{$student->berat_badan}} kg / 靴 (ukuran sepatu): {{$student->ukuran_sepatu}} cm </td>
